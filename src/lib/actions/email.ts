...
export async function sendEmail(email: string, orderId: string) {
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="600" style="max-width: 100%;">
                ...
                <td align="center" style="padding: 20px;">
                    <h2 style="color: #333333; font-size: 24px; margin: 0 0 20px 0;">¡TU ENTRADA PARA THE RABBIT HOLE PARTY!</h2>
                    ...
                    <br> ¡GRACIAS POR TU COLABORACIÓN!
                    </p>
                </td>
                </tr>
            </table>
    ...
    try {
      const response = await fetch('https://api.useplunk.com/v1/send', {
        ...
        body: JSON.stringify({
          to: email,
          subject: '🐇 TU ENTRADA A THE RABBIT HOLE PARTY',
          body: emailBody,
          options: {
            html: true
          }
